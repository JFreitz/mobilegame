...
class office_map : AppCompatActivity(), OnInitListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        backButton = findViewById(R.id.back_button)  // Assuming there is a back button in your office_map layout
        textView = findViewById(R.id.office_popup)  // Assuming there is a TextView in your office_map layout
    ...
    private fun initializeViews() {
        answers = arrayOf(
            findViewById(R.id.office_clock),
            findViewById(R.id.office_trash_bin),
            findViewById(R.id.office_water_dispenser),
            findViewById(R.id.office_drawer),
            findViewById(R.id.office_monitor)
        )
    }
