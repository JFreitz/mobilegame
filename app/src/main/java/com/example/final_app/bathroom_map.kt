...
class bathroom_map : AppCompatActivity(), OnInitListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        backButton = findViewById(R.id.back_button)  // Assuming there is a back button in your bathroom_map layout
        textView = findViewById(R.id.bathroom_popup)  // Assuming there is a TextView in your bathroom_map layout
    ...
    private fun initializeViews() {
        answers = arrayOf(
            findViewById(R.id.bathroom_sink),
            findViewById(R.id.bathroom_towel),
            findViewById(R.id.bathroom_toilet),
            findViewById(R.id.bathroom_washing_machine),
            findViewById(R.id.bathroom_bathtub)
