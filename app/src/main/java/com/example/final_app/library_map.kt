...
class library_map : AppCompatActivity(), OnInitListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        backButton = findViewById(R.id.back_button)  // Assuming there is a back button in your library_map layout
        textView = findViewById(R.id.library_popup)  // Assuming there is a TextView in your library_map layout
    ...
    private fun initializeQuestions() {
        questions = arrayOf(
            "Where is the library sign?",
            "Where are the study tables?",
            "Where is the mythology section?",
            "Where is the ladder?"
        )
    }
    ...
    private fun initializeViews() {
        answers = arrayOf(
            findViewById(R.id.library_sign),
            findViewById(R.id.library_studytable),
            findViewById(R.id.library_mythology_section),
            findViewById(R.id.library_ladder)
        )
    }
    ...
    private fun checkAnswer(selectedButton: Button) {
        val correctAnswerText = when (currentQuestionIndex) {
            0 -> "library_sign"
            1 -> "library_studytable"
            2 -> "library_mythology_section"
            3 -> "library_ladder"
            else -> ""
        }
